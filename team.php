...
?>
<!DOCTYPE html>
<!-- This site was created in Webflow. https://www.webflow.com --><!-- Last Published: Wed Jul 13 2022 13:06:33 GMT+0000 (Coordinated Universal Time) --><html data-wf-page="62bc3fe7d9cc61d9bf26159d" data-wf-site="62bc3fe7d9cc6134bf261592">
	<?php get_template_part("header_block", ""); ?>
	<body class="body black-theme">
    ...
    transform: rotateY(180deg);}
		...
		<main class="wrapper">
			...
			<section class="section wf-section">
				<div class="breadcrumbs-line"><a href="/" class="breadcrumbs-link">Home</a><a href="/press-office" class="breadcrumbs-link"><?php the_title(); ?></a></div>
			</section>
			<section class="section wf-section">
				<div class="head-fest">
					<h1 class="h1-75-90">
			...
			<section class="section wf-section">
				<div class="team-container">
					...
					<?php if( have_rows('team_upper_row') ){ ?>
					<div class="team-cms top">
						<?php global $parent_id; $parent_id = $loop_id; $loop_index = 0; $loop_title="Team upper row"; $loop_field = "team_upper_row"; while( have_rows('team_upper_row') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?>
						<div class="ui-big-man_left-col med">
							<div class="ui-big-man_left-col_mom-img med"><img src="<?php $field = get_sub_field('image'); if(isset($field['url'])){ echo($field['url']); }elseif(is_numeric($field)){ echo(wp_get_attachment_image_url($field, 'full')); }else{ echo($field); } ?>" loading="lazy" alt="<?php echo esc_attr($field['alt']); ?>" class="img-cover" title="<?php echo pathinfo($field['filename'])['filename'] !== $field['title'] ? esc_attr($field['title']) : ''; ?>"></div>
							<div class="ui-big-man_left-col_content-block small">
								...
								<div class="div-block-12"><a rel="nofollow" href="<?php echo get_sub_field('linkedin_link') ?>" target="_blank" class="p-17-25 italic link-color">LinkedIn</a><a rel="nofollow" href="<?php echo get_sub_field('facebook_link') ?>" target="_blank" class="p-17-25 italic link-color">Facebook</a></div>
			...
			<section class="section wf-section">
				<div class="team-container">
					<p class="p-35-45 teamx">
						<?php echo get_field('lower_row_preheader') ?>
					</p>
					<?php if( have_rows('team_lower_row') ){ ?>
					<div class="team-cms bottom">
						<?php global $parent_id; $parent_id = $loop_id; $loop_index = 0; $loop_title="Team lower row"; $loop_field = "team_lower_row"; while( have_rows('team_lower_row') ){ global $loop_id; $loop_index++; $loop_id++; the_row(); ?>
