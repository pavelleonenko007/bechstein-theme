...
if (isset($_GET['source'])) {
    $source_site = 'bechstein';  // Название домена на Webflow без окончания webflow.io
    ...
    if (in_array($source_url['host'], ['webflow-converter.ru', 'test.webflow-converter.ru', 'newshkola.ru'])
