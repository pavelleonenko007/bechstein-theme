...
?>
<!DOCTYPE html>
<!-- This site was created in Webflow. https://www.webflow.com --><!-- Last Published: Wed Jul 13 2022 13:06:33 GMT+0000 (Coordinated Universal Time) --><html data-wf-page="62bc3fe7d9cc6167a126159e" data-wf-site="62bc3fe7d9cc6134bf261592">
			...
			<section class="section wf-section">
				<div class="catalog-row m-revert">
					...
					<div class="yourvisit-column">
						<h1 class="h1-75-90 yv-page">
							<?php the_title(); ?>
						</h1>
						<p class="p-25-40 your-visit">
...
?></script></a>
							...
							<div class="ui-boxoffice-block">
								<div class="cms-press-ajax"><a href="<?php the_permalink(); ?>" class="ui-pressrelease-a w-inline-block"><div class="p-20-30 w20"><?php echo get_the_date(get_option('date_format')); ?></div><div class="p-25-40 mar13"><?php the_title(); ?></div></a><a href="#" class="ui-pressrelease-a w-inline-block"><div class="p-20-30 w20">8 September 2022</div><div class="p-25-40 mar13">Bechstein Hall announces its music season for autumn 2022</div></a><a href="#" class="ui-pressrelease-a w-inline-block"><div class="p-20-30 w20">8 September 2022</div><div class="p-25-40 mar13">Bechstein Hall announces its music season for autumn 2022</div></a></div>
								<div class="t-line fw"></div>
							</div>
							<?php } ?>
