	...
	<main class="wrapper">
		<section class="section wf-section">
			...
			<div class="breadcrumbs-line">
				...
				<a href="/whats-on" class="breadcrumbs-link">what’s on</a>
			</div>
		</section>
		<section class="section wf-section">
			<div class="catalog-row m-revert">
				...
				<div class="yourvisit-column">
					...
					<?php $your_visit_posts = get_posts([
						'post_type' => 'your-visit',
						'post_status' => 'publish'
					]);

					foreach ($your_visit_posts as $your_visit_post) : ?>
						<a href="<?php echo get_the_permalink($your_visit_post); ?>"><?php echo get_the_title($your_visit_post); ?></a>
					<?php endforeach; ?>
