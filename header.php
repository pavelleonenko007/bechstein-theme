        ...
        <div class="right-header">
            <nav role="navigation" class="nav-menu w-nav-menu">
				<?php foreach ( $main_menu_items as $main_menu_item ) : ?>
                    <a href="<?php echo $main_menu_item->url; ?>"
                       title="Go to <?php echo $main_menu_item->title; ?> page"
                       class="navbar-links w-nav-link"><?php echo $main_menu_item->title; ?></a>
				<?php endforeach; ?>
            </nav>
            ...
            <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ) ?>" class="searchhead">
                <input type="search" class="search-input w-input" autofocus="true" maxlength="256"
                       value="<?php echo get_search_query() ?>" name="s" id="s" placeholder=" search by keyword…"
                       required>
                <input type="submit" id="searchsubmit" value="Search" class="search-button-2 w-button"><a href="#"
                                                                                                          class="head-search-btn-closen w-inline-block">
                    <div class="ico-60 w-embed">
                        <svg width="32" height="31" viewbox="0 0 32 31" fill="none">
                            <line y1="-1" x2="40" y2="-1"
                                  transform="matrix(0.707107 0.707106 -0.707107 0.707106 2.00488 2.14209)"
                                  stroke="#030E14" stroke-width="2"></line>
                            <line y1="-1" x2="40" y2="-1"
                                  transform="matrix(0.707107 -0.707106 0.707107 0.707106 2 30.2842)" stroke="#030E14"
                                  stroke-width="2"></line>
                        </svg>
                    </div>
                </a>
...
<iframe src="https://tix.bechsteinhall.func.agency/en/itix" style="display: none;"
        onload="(function(){ console.log('iFrame Loaded'); })();" frameborder="0" id="tix"></iframe>