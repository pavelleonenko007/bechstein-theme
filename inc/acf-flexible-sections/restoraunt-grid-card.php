...
<div class="ui-about">
      ...
      <div class="ui-yourvisit_content">
            ...
            <?php $stars_amount = intval($card['number_of_stars']); ?>
            <div class="html-embed-4 w-embed">
                  <?php if ($stars_amount > 0) : ?>
                        <svg width="91" height="16" viewbox="0 0 91 16" fill="none">
                              <?php if ($stars_amount === 1) : ?>
            ...
            <a rel="nofollow" href="<?php echo $card['link']; ?>" target="_blank" class="ui-about_link"><?php echo $card['link']; ?></a>
      </div>
</div>