				...
				if ( ! empty( $social_links ) ): ?>
                    <div class="foo-soc-line">
						<?php if ( $social_links['youtube'] ): ?>
                            <a href="<?php echo $social_links['youtube']; ?>" class="link-soc w-inline-block"
                               target="_blank">
						...
						<?php if ( $social_links['instagram'] ): ?>
                            <a href="<?php echo $social_links['instagram']; ?>" class="link-soc w-inline-block"
                               target="_blank">
                                <div class="soc-icon w-embed">
						...
						<?php if ( $social_links['twitter'] ): ?>
                            <a href="<?php echo $social_links['twitter']; ?>" class="link-soc w-inline-block"
                               target="_blank">
                                <div class="soc-icon w-embed">
